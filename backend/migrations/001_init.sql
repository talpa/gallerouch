...
-- Migration 002: Add artwork_name to artwork_events (for denormalized reporting)
ALTER TABLE artwork_events ADD COLUMN IF NOT EXISTS artwork_name VARCHAR(255);

-- Migration 003: Add user_id to artwork_events (future user table)
ALTER TABLE artwork_events ADD COLUMN IF NOT EXISTS user_id INTEGER;
